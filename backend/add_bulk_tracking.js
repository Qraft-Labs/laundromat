...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || 'postgresql://postgres:Hussein75@localhost:5432/lush_laundry'
});
...
async function runMigration() {
  ...
  try {
    console.log('🚀 Adding bulk message tracking columns...');
    ...
    console.log('✅ Bulk message tracking columns added successfully!');
  } catch (error) {
